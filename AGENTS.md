...
- Local Postgres: `docker compose up -d` (a shared `jobdetective-postgres-1` container is also used; port 5432).
...
- Tests: `pnpm test` (vitest), `pnpm lint`, `pnpm build`.
